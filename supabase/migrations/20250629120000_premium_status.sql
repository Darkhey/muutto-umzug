...
CREATE POLICY "Users can delete their premium status" ON public.premium_status
  FOR DELETE USING (auth.uid() = user_id);

-- Index for fast lookups by user
CREATE INDEX IF NOT EXISTS idx_premium_status_user_id ON public.premium_status(user_id);
