...
CREATE INDEX idx_tasks_household_status ON public.tasks(household_id, completed);
CREATE INDEX idx_tasks_household_due_date ON public.tasks(household_id, due_date);
