...
import { Calendar, Users, Home, MapPin, Link, ArrowRight, ArrowLeft, CheckCircle, Star, Sparkles, Mail, User, Building, Ruler, DoorOpen, Package2, AlertTriangle, Save } from 'lucide-react'
  ...
  const validateStep = (step: number): boolean => {
    ...
    switch (step) {
      ...
      case 3: {
        ...
        if (data.adUrl) {
          const trimmedUrl = data.adUrl.trim();
